            ...
            <nav className='nav container'>
                ...
                <div className={Toogle ? "nav__menu show-menu": "nav__menu"}>
                    <ul className='nav__list '>
                        ...
                        <li className='nav__item' onClick={()=> showMenu(!Toogle)}>
                            <Link to='/apartmani' onClick={() => setActiveNav('/apartmani')} className={activeNav === "/apartmani" ? "nav__link active-link" : "nav__link"}>
                                Apartmani
                            </Link>
                        </li>
                        <li className='nav__item' onClick={()=> showMenu(!Toogle)}>
                            <Link to='/faq' onClick={() => setActiveNav('/faq')} className={activeNav === "/faq" ? "nav__link active-link" : "nav__link"}>
                                Pitanja i odogovori
                            </Link>
                        </li>
                        <li className='nav__item' onClick={()=> showMenu(!Toogle)}>
                        ...
                        <li className='nav__item' onClick={()=> showMenu(!Toogle)}>
                            <Link to="/wellness" onClick={() => setActiveNav('/wellness')} className={activeNav === "/wellness" ? "nav__link active-link" : "nav__link"}>
                                Wellness
                            </Link>
                        </li>
                        <li className='nav__item' onClick={()=> showMenu(!Toogle)}>
